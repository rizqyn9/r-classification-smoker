...
# Tujuan: Filter KRT, buat target Y, feature engineering, imputasi, siap modeling
...
# =========================
# 2️⃣ Filter KRT & Buat Target Y (Perokok Berat)
# =========================
jambi_krt <- jambi_ind %>%
  filter(R403 == "1") %>%
  mutate(
...
# =========================
# 4️⃣ Konversi ke data.table (jika belum)
# =========================
setDT(df_merged)

# =========================
# 5️⃣ Fungsi bantu: convert to numeric
# =========================
...
# =========================
# Housing Quality Index (buat per kolom dulu)
# =========================
...
for(col in num_cols){
  df_features[is.na(get(col)), (col) := medians[[col]]]
}
